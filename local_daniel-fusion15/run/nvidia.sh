...
source_file="${SETUP_DIR}/local_$(hostname)/data/usr/share/wayland-sessions/plasmawayland-igpu.desktop"
sudo cp $source_file /usr/share/wayland-sessions/plasmawayland-igpu.desktop
sudo chown root:root /usr/share/wayland-sessions/plasmawayland-igpu.desktop
sudo chmod 0644 /usr/share/wayland-sessions/plasmawayland-igpu.desktop

source_file="${SETUP_DIR}/local_$(hostname)/data/usr/local/bin/plasmawayland-igpu"
sudo cp $source_file /usr/local/bin/plasmawayland-igpu
sudo chown root:root /usr/local/bin/plasmawayland-igpu
sudo chmod 0755 /usr/local/bin/plasmawayland-igpu
